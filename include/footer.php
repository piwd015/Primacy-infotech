<section class="footer-bg py-md-5 py-3">
                                            ...
                                            <div class="col-md-3">
                                               ...
                                               <div class="ftr-menu ftr-menu-pt0 position-relative">
                                                  ...
                                                  <form class="form-inline">
                                                      ...
                                                      <button type="submit" class="btn submit-Btn"><i class="fas fa-paper-plane">&nbsp;
                                                          </i></button>
                                                    </form>
                                              </div>
                                        </div>
...
<script>
    grecaptcha.ready(function () {
        ...
        grecaptcha.execute('6LcFWz4aAAAAABu4z5ZLRS7wGLYwHo-GG3sRJk_l', {action: 'forms'}).then(function (token) {
