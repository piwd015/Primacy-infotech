    ...
    <ul id="sidemenu">
                ...
                <ul class="my-col-2">
                        ...
                        <li>
                            <a href="../service/web-developement.php"><i class="icofont-code icofont-2x"></i><br />
                                <div class="txt">Web Development</div></a>
                        </li>
                        <li><a href="../service/web-designing.php"><i class="icofont-dashboard-web icofont-2x"></i>
                                <div class="txt">Web Designing</div>
                            </a>
                        </li>
                        <li><a href="../service/mobile-app-developemnt.php"><i class="icofont-brand-android-robot icofont-2x"></i><br /><div class="txt">Apps Development</div></a>
                        </li>
                        <li><a href="../service/crm-erp-portal-development"><i class="icofont-computer icofont-2x"></i><br /><div class="txt">CRM & ERP Portal Development </div></a>
                        </li>
                        <li><a href="../service/digital-marketing"><i class="icofont-automation icofont-2x"></i>
                            <br /><div class="txt">Digital Marketing</div></a>
                        </li>
                        <li><a href="../service/ui-ux-desing"><i class="icofont-penalty-card icofont-2x"></i><br />
                                <div class="txt">UI/UX Design</div></a>
                        </li>
                        <li><a href="../service/mlm-software-development"><i class="icofont-company icofont-2x"></i><br /><div class="txt">MLM Software Development</div></a>
                        <li><a href="../service/health-care-mangment"><i class="icofont-company icofont-2x"></i>
                            <br /><div class="txt">Halthcare Portal Development</div></a>
                </ul>
        </li>        
        ...
        <li><a href="#"><i class="fa fa-graduation-cap" aria-hidden="true"></i><br>
                ...
                <ul class="my-col-2">
                        ...
                        <li><a href="../oddo/odoo-consulting-services"><i class="icofont-instrument icofont-2x"></i><br /><div class="txt">Odoo Customization</div></a>
                        </li>
                        ...
                        <li><a href="#"><i class="icofont-ui-browser icofont-2x"></i></i>
                            <br /><div class="txt">Odoo Hosting</div></a>
                        </li>
                        <li><a href="#"><i class="icofont-ui-power icofont-2x"></i>
                            <br /><div class="txt">Odoo Demo</div></a>
                        </li>
                        <li><a href="#"><i class="icofont-money-bag icofont-2x"></i>
                            <br /><div class="txt">Odoo Pricing</div></a>
                        </li>
                </ul>
        </li> 
...
<div class="nav-side-menu" id="slide_menu2" style="display:none;">
    ...
    <div class="menu-list">
        ...
        <ul id="menu-content" class="menu-content collapse out">
            ...
            <li  data-toggle="collapse" data-target="#odo" class="collapsed active">
                  <a href="#"><i class="fa fa-graduation-cap" aria-hidden="true"></i> Odoo<span class="arrow"></span></a>
            </li>
            <ul class="sub-menu collapse" id="odo" >
                    <li class="active"><a href="../oddo/odoo-erp.php">Odoo ERP</a></li>
