...
<!-- Google tag (gtag.js) -->
<script async src="https://www.googletagmanager.com/gtag/js?id=G-R30HBGE95R"></script>
<script>
    window.dataLayer = window.dataLayer || [];
    function gtag(){dataLayer.push(arguments);}
    gtag('js', new Date());

    gtag('config', 'G-R30HBGE95R');
</script>
    ...
    <div class="container-fluid">
        <div class="row">
            ...
            <div class="col-md-2 col-12">
                <div class="header-top-right d-block text-right hm-lgo">
            ...
            <div class="col-md-1 tgl-mt hd-menu pt-2">
                ...
                <div id="myCanvs" class="overlay2">
                    <a href="javascript:void(0)" class="closebtn mt-3" onclick="closeNav()">×</a>
