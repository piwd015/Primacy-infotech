                ...
                <div class="col-12 col-sm-3 col-md-2">
                    ...
                    <ul class="list-unstyled quick-links">
                        ...
                        <li>
                            ...
                            <a href="../product/school-managmest-system"><i class="fa fa-angle-double-right"></i>School Management</a>

                        </li>

                        <li><a href=../product/loan-mangment-system><i class="fa fa-angle-double-right"></i>Loan Management</a>

                        </li>

                        <li><a href="../service/health-care-mangment"><i class="fa fa-angle-double-right"></i>Healthcare Management</a>

                        </li>

                        <li><a href="../service/mlm-software-development"><i class="fa fa-angle-double-right"></i>MLM</a>

                        </li>

                        <li><a href="../product/readymade-realestate-portal"><i class="fa fa-angle-double-right"></i>Real Estate</a>

                        <li><a href="../product/portal-accounting"><i class="fa fa-angle-double-right"></i>Accounting</a>
