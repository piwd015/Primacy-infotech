...
<div class="top" data-aos="fade-down">
    <div class="container-fluid px-0">
        <div class="row">
                <div class="col-md-2 col-12 pic0"><a href="../"><img src="assets/images/logo-p.png" class="ml-md-0 ml-2" alt="primacy logo"></a></div>
                                                         ...
                                                         <div class="row">
                                                             <div class="col-lg-6 col-md-6">
                                                                 <ul>
                                                                     ...
                                                                     <li><a href="../oddo/odoo-migration"><i class="icofont-brainstorming icofont-1x"></i>Oddo Migration</a></li>
                                                                     <li><a href="../oddo/odoo-integration"><i class="icofont-test-tube-alt icofont-1x"></i>Odoo Integration</a></li>
                                                                     <li><a href="../oddo/odoo-support"><i class="icofont-cubes icofont-1x"></i>Odoo Support</a></li>
                                                                 </ul>
                                                             </div>
                                                             <div class="col-lg-6 col-md-6">
                                                                 <ul>
                                                                     <li><a href="../oddo/odoo-licensing-consultancy"><i class="icofont-brand-compaq icofont-1x"></i>Odoo Licensing Consultancy</a></li>
                                         ...
                                         <div class="col-md-12">
                                              <div class="row pr-md-5">
                                                     ...
                                                     <div class="col-md-2">
                                                      ...
                                                      <div class="col-md-2">
                                                          <div class="piapps-logo"><a href="/product/ip-attorney-erp" target="_blank"><img src="../assets/images/ipgo-logo.png" alt=""></a></div>
                                                      </div>
                                              </div>
                                         </div>
                                  </div>
