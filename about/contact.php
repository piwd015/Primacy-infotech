...
<!--end fixed header-->
	...
	<!-- header -->
    <section class="h4-contact s-padding bg-color py-md-5 py-3" id="contact">
...
<section class="h7-contact s-padding bg-color pb-md-5 pb-3" id="contact">
