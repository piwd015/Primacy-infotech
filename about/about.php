    ...
    <section class="develp-Area wow slideInUp py-md-5" data-wow-delay=".1s" style="visibility: visible; animation-delay: 0.1s; animation-name: slideInUp;">
            <div class="container-fluid px-md-5">
                   ...
                   <ul class="crt-vlu w-100 d-block text-center pt-5">
                        <li class="mb-md-0 mb-3"><img src="../assets/images/about/create-value.png" class="mr-1" alt=""> We create value</li>
                        <li class="mb-md-0 mb-3"><img src="../assets/images/about/create-value.png" class="mr-1" alt="">We innovate everyday</li>
