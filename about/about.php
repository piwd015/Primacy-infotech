...
<head>
    ...
    <section class="develp-Area wow slideInUp py-md-5" data-wow-delay=".1s" style="visibility: visible; animation-delay: 0.1s; animation-name: slideInUp;">
            <div class="container-fluid px-md-5">
                    <h2 class="w-100 d-block text-center pb-md-4 pb-2">Why We Exit</h2>
                    <p class="d-block text-center">We, unlike robots, do not work only with our brains. We are humans with an uncanny love for
                        technology and immense love for solutions.</p>
                   <ul class="crt-vlu w-100 d-block text-center">
