			  	    ...
			  	    <div class="row pt-md-5 pt-3">
			  	    	  <div class="col-lg-8 col-md-8 mb-md-0 mb-1">
			  	    	  	    ...
			  	    	  	    <ul class="d-block pl-0 py-md-4">
			  	    	  	    	  ...
			  	    	  	    	  <li>Add New Modules To Your Existing<br/> Odoo ERP</li>
			  	    	  	    	  <li>Fast Implementation By Our<br/> Odoo Developers</li>
			  	    	  	    ...
			  	    	  	    <div class="consl-fm w-100 d-block p-4">
			  	    	  	    	   ...
			  	    	  	    	   <form action="" method="post">
											  ...
											  <div class="form-group position-relative">
											        ...
											        <input type="text" class="form-control consl-field ckckphn" placeholder="Phone" id="Ph" name="phone" oninput="this.value=this.value.replace(/[^0-9]/g,'');" onkeyup="phonenumber(this)" maxlength="10" required>
											  ...
											  <div class="form-group position-relative">
											  	     ...
											  	     <textarea class="form-control consl-txt-area" rows="" placeholder="Message" id="comment" name="comment"></textarea>
											  </div>
                      ...
                      <div id="tab-3" class="tab-content3">
                      	     <div class="row d-flex flex-wrap flex-column-reverse flex-md-row">
				      	    	  <div class="col-lg-6 col-md-6">
				      	    	  	    ...
				      	    	  	    <p class="d-block pb-md-4 pb-2">Congratulations, you have selected the best ERP system to run your business. Any ERP implementation is a failure if all your stakeholders are not trained to use the system properly. Let’s work together on the Primacy Infotech proven method of Odoo training for your business.</p>
                     ...
                     <div id="tab-5" class="tab-content3">
                     	    <div class="row d-flex flex-wrap flex-column-reverse flex-md-row">
				      	    	  <div class="col-lg-6 col-md-6">
				      	    	  	    ...
				      	    	  	    <p class="d-block pb-md-4 pb-2">Want 24*7 support for your Odoo ERP system? We have different types of packages available based on the size of your business. Support includes periodic maintenance done automated and manually. Want to learn more?</p>
      	     	   	     	  ...
      	     	   	     	  <div class="row">
			      	     	   	     <div class="col-md-6 pb-md-0 pb-3">
			      	     	   	     	   <ul class="w-100 d-block pl-0">
			      	     	   	     	        ...
			      	     	   	     	        <li class="pb-3 mt-2"><dd><img src="../assets/images/oddo/erp-icon-07.png" alt=""></dd>Hands-on experience in India Finance, Accounting and Taxes using Odoo.</li>
			      	     	   	     	        ...
			      	     	   	     	        <li class="mt-2"><dd><img src="../assets/images/oddo/erp-icon-09.png" alt=""></dd>Hands-on experience supporting manufacturers, retailers, wholesalers and e-commerce companies in the India.</li>
