                  ...
                  <div class="container-fluid">
                         <div class="row d-flex flex-wrap flex-column-reverse flex-md-row">
                               <div class="col-lg-6 col-md-6 position-relative">
                                      ...
                                      <h2 class="d-block ml-md-3 pt-md-4 pt-2">SOMETIMES,<br/><strong>PEOPLE GET CONFUSED</strong><br/>by odoo's
                ...
                <div class="row">
                    <div class="col-md-6">
                        <div class="customz-box p-md-4 p-3 mb-4">
                            <div class="customz-boxImg mb-3"><img src="../assets/images/oddo/enterprise-license.png" alt=""></div>
                            <h5 class="w-100 d-block text-center pb-0">Odoo Enterprise License</h5>
