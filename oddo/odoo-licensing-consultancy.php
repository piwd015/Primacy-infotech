...
" />
    ...
    <div class="page-body mb-5">
          <section class="license-bg lts-cont w-100 d-block">
                         ...
                         <div class="row d-flex flex-wrap flex-column-reverse flex-md-row">
                               <div class="col-lg-6 col-md-6 position-relative">
                                      ...
                                      <h2 class="d-block ml-md-3 pt-md-4 pt-2">SOMETIMES,<br/><strong>PEOPLE GET CONFUSED</strong><br/>by odoo's
                                       ...
                                       <a href="#" class="button" data-toggle="modal" data-target="#myModal_grocery"><span>Talk to your license consultant</span></a>
                               </div>
                               <div class="col-lg-6 col-md-6 position-relative">
