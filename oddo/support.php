                            ...
                            <div class="col-md-6 mb-4">
                                 <ul class="srpt-mnts w-100 d-block">
                                     <li class="pb-3">
                                           ...
                                           <strong class="w-100 d-block pb-3">Dedicated Support Team</strong>
                      ...
                      <table class="table table-bordered table-sm">
                          <thead>
                              <tr>
                                  ...
                                  <th width="25%" style="border:none;"></th>
                                  <th width="25%" class="mst-plr w-100 d-block text-center py-3" style="border:none;">Most Popular</th>
                                  <th width="25%" style="border:none;"></th>
                              </tr>
                               <tr>
