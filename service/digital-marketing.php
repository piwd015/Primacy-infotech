...
<head>
			...
			<div class="row align-items-center">
				<div class="col-lg-6 col-md-7">
					<div class="banner-content">
						<div class="">
							<h2 class="title wow fadeInUp" data-wow-duration=".65s"  data-wow-delay=".1s">Improve Your Website Ranking On <span class="logo-color">GOOGLE SEARCH ENGINE</span><br/><span class="logo-color-red">Primacy Infotech</span></h2>
						</div>
						<div class="">
							<span class="sub-title text-black wow fadeInUp" data-wow-duration=".65s" data-wow-delay=".3s">In order to improve the rankings of the website on Google, certain measures are taken by our company. The package of Digital Marketing starts from Rs 9,999. If you want to contact us, we are just a call away.</span>
						</div>
    	  	   ...
    	  	   <div class="row pt-3">
    	  	   	    <div class="col-md-4 mb-4">
    	  	   	    	 <div class="develp-Area-box w-100 d-block p-md-4 p-3"> 
    	  	   	    	 	<img src="../assets/images/service/digi-markt-consul.png">
    	  	   	    	 	<h3 class="d-block py-2">Digital Marketing Consulting</h3>
    	  	   	    	 	<p class="d-block">Digital Marketing is continuously evolving and can be very confusing. It is critical to have a crisp, sorted-out, business-aligned strategy to get the maximum return on your investments.</p>
    	  	   	    	 	<p class="d-block">We put together the right strategy, baseline, metrics, knowledge, techniques, and insights suitable to your business and industry.</p>
    	  	   	    	 </div>
    	  	   	    </div>
    	  	   	    <div class="col-md-4 mb-4">
    	  	   	    	  <div class="develp-Area-box w-100 d-block p-md-4 p-3"> 
    	  	   	    	 	<img src="../assets/images/service/integrated-digi-markt.png">
    	  	   	    	 	<h3 class="d-block py-2">Integrated Digital Marketing</h3>
    	  	   	    	 	<p class="d-block">The whole is greater than the sum of its parts – Aristotle</p>
    	  	   	    	 	<p class="d-block">In the digital parlance, this is most relevant for integrated digital marketing. You need an end-to-end strategy using the suitable tools in the right order and quantity to get the best outcome for your business. Let us help you with this digital mix!</p>
    	  	   	    	 </div>
    	  	   	    </div>
    	  	   	    <div class="col-md-4 mb-4">
    	  	   	    	  <div class="develp-Area-box w-100 d-block p-md-4 p-3"> 
    	  	   	    	 	<img src="../assets/images/service/seo-icon.png">
    	  	   	    	 	<h3 class="d-block py-2">Search Engine Optimization</h3>
    	  	   	    	 	<p class="d-block">Search Engine Optimization (SEO) is about getting the right and optimized website structure, user-centric design, quality links, and citations. It needs multi-disciplinary skills to get-it-done, and we are right on top of the game.</p>
         	  	   	    	 </div>
    	  	   	    </div>
    	  	   	    <div class="col-md-4 mb-4">
    	  	   	    	  <div class="develp-Area-box w-100 d-block p-md-4 p-3"> 
    	  	   	    	 	<img src="../assets/images/service/social-media.png">
    	  	   	    	 	<h3 class="d-block py-2">Social Media Marketing</h3>
    	  	   	    	 	<p class="d-block">Social media is an effective and efficient medium to interactively engage targeted users, and get your brand and marketing message across them. It needs careful planning, messaging and use of technology. We make it happen for you.</p>
    	  	   	    	 </div>
    	  	   	    </div>
    	  	   	    <div class="col-md-4 mb-4">
    	  	   	    	  <div class="develp-Area-box w-100 d-block p-md-4 p-3"> 
    	  	   	    	 	<img src="../assets/images/service/app-store.png">
    	  	   	    	 	<h3 class="d-block py-2">App Store Optimization</h3>
    	  	   	    	 	<p class="d-block">It is critical to have a good App to be successful. However, it is important to do App Store Optimisation (ASO) across iTunes and Google Play Store to ensure that you get your due rankings. We help you get your rightful position in the app store rankings.</p>    	    	 	
    	  	   	    	 </div>
    	  	   	    </div>
    	  	   	    <div class="col-md-4 mb-4">
    	  	   	    	  <div class="develp-Area-box w-100 d-block p-md-4 p-3"> 
    	  	   	    	 	<img src="../assets/images/service/ppc-management.png">
    	  	   	    	 	<h3 class="d-block py-2">PPC Management</h3>
    	  	   	    	 	<p class="d-block">We work tirelessly to squeeze out the best return on investment from paid search advertising for you through a holistic approach encompassing:</p>
    	  	   	    	 	<ul class="w-100 d-block">
    	  	   	    	 		<li class="d-block pb-2">Keyword and competitive research</li>
    	  	   	    	 		<li class="d-block pb-2">Landing page optimisation / conversion rate optimisation (CRO)</li>
    	  	   	    	 		<li class="d-block">Appealing creatives</li>
    	  	   	    	 	</ul>
    	  	   	    	 </div>
    	  	   	    </div>
    	  	   	    <div class="col-md-4 mb-4">
    	  	   	    	  <div class="develp-Area-box w-100 d-block p-md-4 p-3"> 
    	  	   	    	 	<img src="../assets/images/service/media-buying.png">
    	  	   	    	 	<h3 class="d-block py-2">Media Buying & Planning</h3>
    	  	   	    	 	<p class="d-block">Media planning, buying, and management are key to drive proper Returns on Investment (RoI) from your digital advertising spend. The medium gives the flexibility to change targeting, messaging and call-to-action in real-time and hence need an expert to manage it for you. We do the needful with acute business sense.</p>
    	  	   	    	 </div>
    	  	   	    </div>
    	  	   	    <div class="col-md-4 mb-4">
    	  	   	    	  <div class="develp-Area-box w-100 d-block p-md-4 p-3"> 
    	  	   	    	 	<img src="../assets/images/service/email-marketing.png">
    	  	   	    	 	<h3 class="d-block py-2">Email Marketing</h3>
    	  	   	    	 	<p class="d-block">Email marketing delivers the highest ROI among all digital marketing mediums, if done right. It engages your audience and converts them when they have a need for your offering. We help you plan and execute your email marketing calendar to precision.</p>
    	  	   	    	 </div>
    	  	   	    </div>   	  	   	   
    	  	   	    <div class="col-md-4 mb-4">
    	  	   	    	  <div class="develp-Area-box w-100 d-block p-md-4 p-3"> 
    	  	   	    	 	<img src="../assets/images/service/website-maintenance.png">
    	  	   	    	 	<h3 class="d-block py-2">Website Maintenance</h3>
    	  	   	    	 	<p class="d-block">We maintain your website through our full-service team to ensure you get a time-bound one-stop solution. We ensure speed, security, freshness and brand styling for your digital assets in this fast-changing technology landscape through our creative, technology and digital marketing services.</p>
    	  	   	    	 </div>
    	  	   	    </div>
    	  	   </div>
    	  </div>
	...
	<section class="quick-overview s-padding pb-4">
		<div class="container-fluid px-md-5 px-4">
			<div class="s-title mt-0 mb-md-4 mb-5 pb-md-0">
				<h2><span class="logo-color">Q</span>uick Overview</h2>
			</div>
			<div class="row">
				<div class="col-12">
					<div class="quick-overview-tab-wrapper text-center pt-md-0 pt-5">
						  			...
						  			<div class="col-lg-5 offset-lg-1">
						  				...
						  				<div class="quick-overview-content">
						  					...
						  					<ul class="iconic-icon-list">
						  						...
						  						<li><i class=" arrow_carrot-right"></i> <span>Blog & Content Creation</span></li>

			<li><i class=" arrow_carrot-right"></i> <span>On Page SEO</span></li>

			<li><i class=" arrow_carrot-right"></i> <span>Pay-Per-Click Marketing</span></li>
