...
<!--				<p>Ut totam hymenaeos a quasi enim, duis erat mollitia, pellentesque ac metus!</p>-->
			...
			<div class="row justify-content-center">
				...
				<div class="col-lg-4">
					...
					<div class="icon-box style-boxed">
						...
						<div class="icon-box-details">
							...
							<h3 class="icon-box-title">I-Pin / E-Pin Joining

</h3>

							<p>Secure prepaid membership payment, Pin report, Pin allocation, prepaid voucher.</p>
				...
				<i class="icofont-envelope-open"></i>
						...
						<div class="icon-box-details">
							...
							<h3 class="icon-box-title">SMS Sending Integration



</h3>

							<p>Send group SMS, Registration, Payout, Report, Announcement to the members auto from software
				...
				<div class="col-lg-4">
					...
					<div class="icon-box style-boxed">
						...
						<div class="icon-box-details">
							...
							<p>SSL Certificate, Mirror server, Co-Location, Daily Backup, Daily monitoring for your software
				...
				<div class="col-lg-4">
					...
					<div class="icon-box style-boxed">
						...
						<div class="icon-box-details">
							...
							<h3 class="icon-box-title">Flash MLM Plan



</h3>

							<p>High-quality professional flash presentation of your business plan for marketing
				...
				<i class="icofont-network"></i>
						...
						<div class="icon-box-details">
							...
							<h3 class="icon-box-title">Stable MLM Software



</h3>

							<p>Affordable MLM software Multi Level, Binary MLM Board Plan, Spillover Rewards, Multiple trees
	...
	<section class="about s-padding pt-3 mt-0">
		<div class="container-fluid px-md-5 px-3">
			<div class="row align-items-center">
				<div class="col-lg-5">
