...
<div id="menuwrapper">
    <ul id="sidemenu">
        <li><a class="" href="../"><i class="fas fa-home"><br>Home</i></a></li>
        ...
        <li><a href="#"><i class="fas fa-server"><br>
            ...
            <ul class="my-col-2">
                ...
                <li><a href="../service/crm-erp-portal-development%20"><i class="icofont-computer icofont-2x"></i><br />
                ...
                <li><a href="../service/ui-ux%20Desing"><i class="icofont-penalty-card icofont-2x"></i><br />
                        <div class="txt">UI/UX Design</div>
                    </a>
                </li>
                <li><a href="../service/mlm-software-development%20"><i class="icofont-company icofont-2x"></i><br />
        ...
        <li><a href="#"><i class="fas fa-industry"><br>
          ...
          <li><a class="noflyout selected" href="../about/contact"><i class="fas fa-envelope"><br>Contact US</i></a></li>
    ...
    <div class="menu-list">
        ...
        <ul id="menu-content" class="menu-content collapse out">
            ...
            <ul class="sub-menu collapse" id="products">
                ...
                <li><a href="../service/ui-ux%20Desing">UI/UX Design</a>
                </li>
                <li><a href="../service/mlm-software-development">MLM Software Development</a></li>
...
<div class="menu-footer">
    ...
    <ul class="menu2">
        ...
        <li><a class="noflyout selected" href="../about/our-company"><i class="fas fa-building">&nbsp;Company</i></a></li>
        <li><a class="noflyout selected" href="../about/contact"><i class="fas fa-envelope">&nbsp;Contact US</i></a></li>
