...
<head>
	...
	<title>Best Loan Mangement Portal in India</title>

	<meta name="description" content="Primacy Infotech is one of the loan management portal companies in India. Call us on 9088015866 to get your service in affordable prices." />

	<meta name="keywords" content="Loan Management system, Best loan management system software, Loan management system company in kolkata, Loan management system software company in India, Loan management software in India, Loan Managment App" />
			...
			<div class="row align-items-center">
				...
				<div class="col-lg-6 col-md-7">
					...
					<div class="banner-content">
						...
						<div class="">
							...
							<h2 class="title wow fadeInUp" data-wow-duration=".65s"  data-wow-delay=".1s">We are the most trusted brand which can provide you with flexible as well as hardy services, and we can solve any of your problems with great ease. This software called <span class="logo-color">Loan Management System </span>, can provide you with any solutions related to loan.  The package for loan management is <span class="logo-color-red">RS 40,000/-</span>.   </h2> 
						...
						<!--<div class="">
							...
							<span class="sub-title wow fadeInUp" data-wow-duration=".65s" data-wow-delay=".3s">LOAN MANAGEMENT START FROM <span class="logo-color-red">RS 40,000/-</span></span>
				...
				<div class="col-lg-6 col-md-5 d-none d-md-block">
					...
					<div class="banner-content">
						...
						<img src="../assets/images/health.gif" class="img-fluid" alt="health software">
				...
				<div class="col-lg-4">
					...
					<div class="icon-box style-boxed">
						...
						<div class="icon-box-details">
							...
							<h3 class="icon-box-title">Loan management software

</h3>

							<p>We are versatile, compatible with the 

customers as well as seamless operations and perfect resolutions. </p>
				...
				<i class="icofont-envelope-open"></i>
						...
						<div class="icon-box-details">
							...
							<h3 class="icon-box-title">Loan management system



</h3>

							<p>we are here to increase the customer service experience as well as the productivity. We are versatile, compatible with the customers as well as seamless operations and perfect resolutions. 
				...
				<div class="col-lg-4">
					...
					<div class="icon-box style-boxed">
						...
						<div class="icon-box-details">
							...
							<h3 class="icon-box-title">Get loan management software,

</h3>

							<p>You can get the best loan management software 

over here and we are here to meet all your needs. Customers can be maintained 
				...
				<div class="col-lg-4">
					...
					<div class="icon-box style-boxed">
						...
						<div class="icon-box-details">
							...
							<h3 class="icon-box-title">Loan management app



</h3>

							<p> Is the kind of app which is designed for customers who want 

instant services.  It can give you a solution which you can get instantly.  
				...
				<i class="icofont-network"></i>
						...
						<div class="icon-box-details">
							...
							<h3 class="icon-box-title">Loan management agreement



</h3>

							<p>loan management agreement fully utilize  the line of 
				...
				<div class="col-lg-4">
					...
					<div class="icon-box style-boxed">
						...
						<div class="icon-box-details">
							...
							<h3 class="icon-box-title">Loan management personalized

</h3>

							<p>As per specific business, you can understand 

everything related to the loan management system.  
			...
			<div class="row align-items-center">
				...
				<div class="col-lg-5">
					...
					<div class="about-content">
						...
						<h2>Why <span class="logo-color">Loan </span>Software</h2>

						<p>Primacy infotech offers you with the best loan management systems and solutions.  A lot of people 

can benefit from certain things. Customer service excellence is the main thing on which people can 

focus. Granular reporting and capabilities of the dashboard are a few things to focus on.  Loan 

management system includes a lot of things like quality, best services for customers, turn around 

time, efficient lending services and transparency which matters.  
				...
				<div class="col-lg-6 offset-lg-1 about-images-wrapper d-none d-md-block">

<!--				<img src="assets/images/app-mockup.png" class="about-img1 wow slideInRightAlt"  alt="#primacy">-->

                    <img src="../assets/images/loan.jpg" class="img-fluid about-img1 wow slideInRightAlt" alt="mlm">
			...
			<div class="offset-lg-1"></div>
				...
				<div class="col-lg-5 d-none d-md-block">
					...
					<div class="faq-sec-img">
						...
						<img class="wow slideInLeft" src="../assets/images/loan-cycle.jpg" alt="loan">
					  	...
					  	<div class="card accordion-item">
					    	...
					    	<div id="accordionItem2" class="collapse" aria-labelledby="accordionHeading2" data-parent="#iconicAccordion">
					      		...
					      		<div class="card-body accordion-body">
					        		...
					        		<ol><li><strong>What does your company do, and what is the purpose of your website?</strong></li><li><strong>What pages would you like on the website? (e.g. Home, About, Services, Contact).</strong></li><li><strong>List any websites you like. Perhaps from a color, style or layout point of view. </strong></li><li><strong>Please note that the website does not have&nbsp;to be the same type of business, we are just trying to understand the style that you require.</strong></li><li><strong>What is the target audience of your company / website?</strong></li><li><strong>Please tell us if you have an existing logo and color scheme. If not, is there a colour scheme or logo idea that you would like to suggest?</strong></li><li><strong>Do you have any companies in the same field that you are competing against? If you know of any, please provide the name or website address of them.</strong></li><li><strong>If you have anything else that you feel has not been covered by this questionnaire please list your comments here.</strong></li></ol>
