        ...
        <section>
            <div class="container-fluid px-md-5 px-3 ecommerces_features">
                ...
                <div class="row product_features">
                    ...
                    <div class="col-md-4 d-flex flex-wrap justify-content-center px-md-0">
                           <div class="ipgo-appImg">
                                 <img src="../assets/images/product/ipgo-app.png" alt="">
                           </div>
                    </div>
                    ...
                    <div class="col-lg-4 col-md-4 col-sm-12">
                        ...
                        <!-- Single Features -->
                        <div class="veticle-features mb-0">
                            <div class="veticle-features-item mb-md-3 mb-1">
                                <div class="veticle-large-features-box">
