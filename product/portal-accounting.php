...
<head>
	...
	<title>Best Accounting portal Development  service in India</title>

	<meta name="description" content="Primacy Infotech is one of the best accounting development companies in India. Call us on 9088015866 to get your website in affordable prices." />

	<meta name="keywords" content="Account Management system, Account management software, Best account management system company in India, Best account management software company in India, Accounting Management software company in kolkata" />
        ...
        <div class="row align-items-center">
            <div class="col-lg-7 col-md-7">
                <div class="attorney-bnr-txt pt-5">
                    ...
                    <p class="d-block pb-md-2 mb-2">Intellectual Property Management software for
                        forward thinking IP professionals.</p>
                    <p class="d-block pb-md-3 mb-2">IPGO is a modern cloud-based Intellectual Property Management
				...
				<div class="col-lg-6 col-md-6">
					...
					<div class="banner-content banner-content3">
						...
						<div class="ovh">
							...
							<h3 class="title wow slideInDownBig" data-wow-duration=".65s"  data-wow-delay=".1s">GET YOUR ONLINE ACCOUNTING PORTAL CALL-<span class="logo-color"> 9088015866 / 65 </span></h3>

						</div>

						<div class="ovh">

							<span class="sub-title wow slideInDownBig text-white" data-wow-duration=".65s" data-wow-delay=".3s">Enterprise resource planning and customer relationship manangement are both same in  a number of ways and both help in increasing the business profitability.
			...
			<div class="row align-items-center">
				...
				<div class="col-lg-6">
					...
					<div class="img-wrapper img-center h4-about-img-wrapper">
						...
						<img src="../assets/images/primacy-accounting.gif" class="about-img1 wow slideInLeft" alt="#primacy">
				...
				<div class="col-lg-6">
					...
					<div class="about-content">
						...
						<h2>Account Software</h2>

						<p>Privacy infotech pvt limited online account software in order to run the business in a professional manner. Recording different information is a part of our business. Account solutions provide planning of data in terms of planning and costing of a certain product and records all the activities. Inventory, shipping details and payment are involved in terms of accounting. Account software of primacy infotech provides with a combined details of sales, manufacturing, marketing and delivery.
				...
				<div class="col-lg-3 col-md-6">
					...
					<div class="icon-box awf-item wow slideInUp">
						...
						<div class="icon-box-details">
							...
							<h3 class="icon-box-title">Accounting software </h3>

							<p>It  has major roles to play including tackling of the business in a professional way.  Inventory aand shipping details as well as economic forecasts are handled by this software. </p>
...
-->
					...
					<div class="icon-box awf-item mb-md-0 wow slideInUp" data-wow-delay=".1s">
						...
						<div class="icon-box-details">
							...
							<h3 class="icon-box-title">Accounting rules 



</h3>

							<p>There are certain rules that has to be followed in order to maintain the accounting software.</p>
				...
				<div class="col-lg-3 offset-lg-1 col-md-6">
					...
					<div class="icon-box awf-item wow slideInUp">
						...
						<div class="icon-box-details">
							...
							<h3 class="icon-box-title">Accounting Reports</h3>

							<p>There are certain reports made with the of accounting software. It records a track of financial information related to the business. Financial records are mazintained extensively. </p>
					...
					<div class="icon-box awf-item mb-0 wow slideInUp" data-wow-delay=".1s">
						...
						<div class="icon-box-details">
							...
							<h3 class="icon-box-title">Accounting and auditing



</h3>

							<p>Audit is an independent examination of accounting. </p>
				...
				<div class="col-lg-3 offset-lg-1 col-md-6">
					...
					<div class="icon-box awf-item wow slideInUp">
						...
						<div class="icon-box-details">
							...
							<p>It increases the sales and also the managementg of stock is taken care of. Orders are managed and tracking is also done. Warehouse management is aalso a part of it.
					...
					<div class="icon-box awf-item mb-0 wow slideInUp" data-wow-delay=".1s">
						...
						<div class="icon-box-details">
							...
							<h3 class="icon-box-title">Accounting APP



</h3>

							<p>It involves keeping the tracks of transactions that includes payments that are transferred and payments that are received.
