...
<head>
	...
	<title>Realestate Portal service in kolkata</title>

	<meta name="description" content="Primacy Infotech is one of the best Realstate portal services in India. Call us on 9088015866 to get your website in affordable prices." />

	<meta name="keywords" content="Realstate development agencies, Real state development company in Kolkata, real state development company in India, Real stae, Real state app development company in India, Real state app development company" />
	...
	<div class="container">
		...
		<div class="row align-items-center">
			...
			<div class="col-lg-6  col-md-6">
				...
				<div class="banner-content banner-content3">

					<div class="ovh">

						<h3 class="title wow slideInDownBig" data-wow-duration=".65s" data-wow-delay=".1s">GET YOUR ONLINE REAL ESTATE PORTAL CALL-<span class="text-white"> 9088015866 / 65 </span></h3>

					</div>

					<div class="ovh">

						<span class="sub-title wow slideInDownBig text-white" data-wow-duration=".65s" data-wow-delay=".3s">We are known to transform the real estate market from paper to the digital world which makes the property marketing very easy to access for buyers and sellers from both the ends. If you want to reach us, we are just one call away. 
					...
					<div class="btn-wrapper ovh">
						...
						<button type="button" class="btn custom-btn slid-button mb " data-toggle="modal" data-target="#myModal" href="#">Get Started <i class="icon-layers"></i></button>
...
-->
			...
			<div class="col-lg-6 col-md-6 h3-banner-img-wrapper">

				<!--

					<img src="assets/images/banner-mobile3.png" class="h3-banner-img-1 wow slideInDown" data-wow-delay=".1s" alt="#primacy">

					<img src="assets/images/banner-mobile4.png" class="h3-banner-img-2 wow slideInDown" alt="#primacy">

-->

				<img src="../assets/images/portal-realestate.png" class="h3-banner-img-1 wow slideInDown" data-wow-delay=".1s" alt="#primacy">
		...
		<div class="row align-items-center">
			...
			<div class="col-lg-6 d-none d-md-block">
				...
				<div class="img-wrapper img-center h4-about-img-wrapper">
					...
					<img src="../assets/images/realestater.gif" class="about-img1 wow slideInLeft" alt="#primacy">
			...
			<div class="col-lg-6 ">
				...
				<div class="about-content">
					...
					<h2>Development of Real Estate </h2>

					<p>We are into transforming the real estate market so that it can be visible to the

						customers much more. Real estate development is a part of business process. We

						cover all the various facets of the real ecosystem of real estate which include the

						buyers, sellers and tenants in case of hiring mediators who act as the middlemen

						and also aggregators who bring certain territories.
					...
					<div class="btn-wrapper">
						...
						<button type="button" class="btn fill-style custom-btn slid-button mb " data-toggle="modal" data-target="#myModal" href="#">Get Started <i class="icon-layers"></i></button>
			...
			<div class="col-lg-4 col-md-4 ">
				...
				<div class="icon-box awf-item wow slideInUp">
					...
					<div class="icon-box-details">
						...
						<h3 class="icon-box-title">View 3D</h3>

						<p>Customers can get a big 3D view of the whole property as it is very

							much attractive to the buyers yet allows them to have an entire knowledge

							and idea on the property. </p>

						<!--

							<p><i class="fa fa-hand-o-right" ></i>Feed important information of customers.

</p>

					<p><i class="fa fa-hand-o-right" ></i>Capture both registered and shipping address.

</p>

					<p><i class="fa fa-hand-o-right" ></i>Set birthday Reminders of your customers.
...
-->
					...
					<p><i class="fa fa-hand-o-right" ></i>Edit and sort customer details.
...
-->
				...
				<div class="icon-box awf-item mb-md-0 wow slideInUp" data-wow-delay=".1s">
					...
					<div class="icon-box-details">
						...
						<h3 class="icon-box-title">Favourites</h3>

						<p> This feature allows the user for adding the list of properties which

							are mostly preferred. </p>

						<!--

							<p><i class="fa fa-hand-o-right" ></i>Link quotes to accounts, contacts, or opportunities.</p>

							<p><i class="fa fa-hand-o-right" ></i>Quick quotes for pricing and availability.</p>

							<p><i class="fa fa-hand-o-right" ></i>Publish and send in various formats, PDF, MSWord etc.</p>

							<p><i class="fa fa-hand-o-right" ></i>Customise Invoices & Quotes using Logo & Company details.</p>
			...
			<div class="col-lg-4   col-md-4">
				...
				<div class="icon-box awf-item wow slideInUp">
					...
					<div class="icon-box-details">
						...
						<h3 class="icon-box-title">Calendar </h3>

						<p> A few things are kept on check with the help of this feature. </p>

						<!--

							<p><i class="fa fa-hand-o-right" ></i>Link between equipment and spare parts</p>

							<p><i class="fa fa-hand-o-right" ></i>Detailed stock management</p>

							<p><i class="fa fa-hand-o-right" ></i>Maintain safety stock (also called buffer stock).</p>

							<p><i class="fa fa-hand-o-right" ></i>Safety stock maximizes customer service
...
-->
				...
				<div class="icon-box awf-item mb-0 wow slideInUp" data-wow-delay=".1s">
					...
					<div class="icon-box-details">
						...
						<h3 class="icon-box-title">Map



						</h3>

						<p>It provides you with a good idea of the routes, distance and other

							locations. </p>

						<!--

							<p><i class="fa fa-hand-o-right" ></i>Attendance Management</p>

							<p><i class="fa fa-hand-o-right" ></i>Manage HR & Payroll</p>

							<p><i class="fa fa-hand-o-right" ></i>Compliant with Indian payroll statutory and taxes.</p>

							<p><i class="fa fa-hand-o-right" ></i>Upload employees scan documents</p>

							<p><i class="fa fa-hand-o-right" ></i>Pay your suppliers on time.</p>

-->

						<!--

							<p>Information on billing ,payments & invoices
			...
			<div class="col-lg-4  col-md-4">
				...
				<div class="icon-box awf-item wow slideInUp">
					...
					<div class="icon-box-details">
						...
						<h3 class="icon-box-title">Details of the broker</h3>

						<p>Where the right details of the buyers are present are
...
-->
				...
				<div class="icon-box awf-item mb-0 wow slideInUp" data-wow-delay=".1s">
					...
					<div class="icon-box-details">
						...
						<h3 class="icon-box-title">Sorting



						</h3>

						<p><i class="fa fa-hand-o-right"></i>App users can usually sort the properties from “high to low “or from
			...
			<!--
				...
				<div class="col-lg-3 offset-lg-1">
					...
					<div class="img-wrapper img-center wow slideInUp mb-5 mb-lg-0">
						...
						<img src="assets/images/feature-m2.png" alt="#primacy">
